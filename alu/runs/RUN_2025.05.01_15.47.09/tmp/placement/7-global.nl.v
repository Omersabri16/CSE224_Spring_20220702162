module alu (A,
 ...
 sky130_fd_sc_hd__inv_2 _165_ (.A(OPCODE[2]),
    .Y(_093_));
 sky130_fd_sc_hd__or2_2 _166_ (.A(OPCODE[0]),
    .B(OPCODE[1]),
    .X(_094_));
 sky130_fd_sc_hd__nor2_2 _167_ (.A(_093_),
    .B(_094_),
    .Y(_095_));
 sky130_fd_sc_hd__buf_1 _168_ (.A(B[3]),
    .X(_096_));
 sky130_fd_sc_hd__nand2_2 _169_ (.A(A[1]),
    .B(_096_),
    .Y(_097_));
 sky130_fd_sc_hd__buf_1 _170_ (.A(A[2]),
    .X(_098_));
 sky130_fd_sc_hd__nand2_2 _171_ (.A(B[1]),
    .B(_098_),
    .Y(_099_));
 sky130_fd_sc_hd__buf_1 _172_ (.A(A[3]),
    .X(_100_));
 sky130_fd_sc_hd__nand2_2 _173_ (.A(B[2]),
    .B(_100_),
    .Y(_101_));
 sky130_fd_sc_hd__a22o_2 _174_ (.A1(_098_),
    .A2(B[2]),
    .B1(_100_),
    .B2(B[1]),
    .X(_102_));
 sky130_fd_sc_hd__o21ai_2 _175_ (.A1(_099_),
    .A2(_101_),
    .B1(_102_),
    .Y(_103_));
 sky130_fd_sc_hd__nand2_2 _176_ (.A(A[1]),
    .B(B[2]),
    .Y(_104_));
 sky130_fd_sc_hd__a22oi_2 _177_ (.A1(B[1]),
    .A2(_098_),
    .B1(_100_),
    .B2(B[0]),
    .Y(_105_));
 sky130_fd_sc_hd__and4_2 _178_ (.A(B[0]),
    .B(B[1]),
    .C(_098_),
    .D(_100_),
    .X(_106_));
 sky130_fd_sc_hd__o21bai_2 _179_ (.A1(_104_),
    .A2(_105_),
    .B1_N(_106_),
    .Y(_107_));
 sky130_fd_sc_hd__xnor2_2 _180_ (.A(_103_),
    .B(_107_),
    .Y(_108_));
 sky130_fd_sc_hd__xnor2_2 _181_ (.A(_097_),
    .B(_108_),
    .Y(_109_));
 sky130_fd_sc_hd__or3_2 _182_ (.A(_106_),
    .B(_104_),
    .C(_105_),
    .X(_110_));
 sky130_fd_sc_hd__o21ai_2 _183_ (.A1(_106_),
    .A2(_105_),
    .B1(_104_),
    .Y(_111_));
 sky130_fd_sc_hd__a22o_2 _184_ (.A1(A[1]),
    .A2(B[1]),
    .B1(_098_),
    .B2(B[0]),
    .X(_112_));
 sky130_fd_sc_hd__and4_2 _185_ (.A(B[0]),
    .B(A[1]),
    .C(B[1]),
    .D(_098_),
    .X(_113_));
 sky130_fd_sc_hd__a31o_2 _186_ (.A1(A[0]),
    .A2(B[2]),
    .A3(_112_),
    .B1(_113_),
    .X(_114_));
 sky130_fd_sc_hd__a21o_2 _187_ (.A1(_110_),
    .A2(_111_),
    .B1(_114_),
    .X(_115_));
 sky130_fd_sc_hd__and3_2 _188_ (.A(_110_),
    .B(_111_),
    .C(_114_),
    .X(_116_));
 sky130_fd_sc_hd__a31o_2 _189_ (.A1(A[0]),
    .A2(_096_),
    .A3(_115_),
    .B1(_116_),
    .X(_117_));
 sky130_fd_sc_hd__nand2_2 _190_ (.A(_109_),
    .B(_117_),
    .Y(_118_));
 sky130_fd_sc_hd__xor2_2 _191_ (.A(_109_),
    .B(_117_),
    .X(_119_));
 sky130_fd_sc_hd__nand2_2 _192_ (.A(A[0]),
    .B(B[2]),
    .Y(_120_));
 sky130_fd_sc_hd__and2b_2 _193_ (.A_N(_113_),
    .B(_112_),
    .X(_121_));
 sky130_fd_sc_hd__xnor2_2 _194_ (.A(_120_),
    .B(_121_),
    .Y(_122_));
 sky130_fd_sc_hd__and4_2 _195_ (.A(B[0]),
    .B(A[0]),
    .C(A[1]),
    .D(B[1]),
    .X(_123_));
 sky130_fd_sc_hd__and2_2 _196_ (.A(_122_),
    .B(_123_),
    .X(_124_));
 sky130_fd_sc_hd__nand2_2 _197_ (.A(A[0]),
    .B(_096_),
    .Y(_125_));
 sky130_fd_sc_hd__and2b_2 _198_ (.A_N(_116_),
    .B(_115_),
    .X(_126_));
 sky130_fd_sc_hd__xnor2_2 _199_ (.A(_125_),
    .B(_126_),
    .Y(_127_));
 sky130_fd_sc_hd__nand3_2 _200_ (.A(_119_),
    .B(_124_),
    .C(_127_),
    .Y(_128_));
 sky130_fd_sc_hd__and2b_2 _201_ (.A_N(_103_),
    .B(_107_),
    .X(_129_));
 sky130_fd_sc_hd__and3_2 _202_ (.A(A[1]),
    .B(_096_),
    .C(_108_),
    .X(_130_));
 sky130_fd_sc_hd__and3_2 _203_ (.A(B[2]),
    .B(_100_),
    .C(_099_),
    .X(_131_));
 sky130_fd_sc_hd__nand2_2 _204_ (.A(_098_),
    .B(_096_),
    .Y(_132_));
 sky130_fd_sc_hd__xnor2_2 _205_ (.A(_131_),
    .B(_132_),
    .Y(_133_));
 sky130_fd_sc_hd__nor3_2 _206_ (.A(_129_),
    .B(_130_),
    .C(_133_),
    .Y(_134_));
 sky130_fd_sc_hd__o21ai_2 _207_ (.A1(_129_),
    .A2(_130_),
    .B1(_133_),
    .Y(_135_));
 sky130_fd_sc_hd__or2b_2 _208_ (.A(_134_),
    .B_N(_135_),
    .X(_136_));
 sky130_fd_sc_hd__a21oi_2 _209_ (.A1(_118_),
    .A2(_128_),
    .B1(_136_),
    .Y(_137_));
 sky130_fd_sc_hd__and3_2 _210_ (.A(_118_),
    .B(_128_),
    .C(_136_),
    .X(_138_));
 sky130_fd_sc_hd__nor2_2 _211_ (.A(_137_),
    .B(_138_),
    .Y(_139_));
 ...
 sky130_fd_sc_hd__nor2_2 _213_ (.A(OPCODE[2]),
    .B(_140_),
    .Y(_141_));
 sky130_fd_sc_hd__or2_2 _214_ (.A(OPCODE[2]),
    .B(_094_),
    .X(_142_));
 sky130_fd_sc_hd__buf_1 _215_ (.A(_142_),
    .X(_143_));
 sky130_fd_sc_hd__nor2_2 _216_ (.A(A[5]),
    .B(_143_),
    .Y(_144_));
 sky130_fd_sc_hd__nand2_2 _217_ (.A(OPCODE[0]),
    .B(_093_),
    .Y(_145_));
 sky130_fd_sc_hd__nor2_2 _218_ (.A(OPCODE[1]),
    .B(_145_),
    .Y(_146_));
 sky130_fd_sc_hd__or3b_2 _219_ (.A(OPCODE[0]),
    .B(OPCODE[2]),
    .C_N(OPCODE[1]),
    .X(_147_));
 sky130_fd_sc_hd__buf_1 _220_ (.A(_147_),
    .X(_148_));
 sky130_fd_sc_hd__a21oi_2 _221_ (.A1(B[5]),
    .A2(A[5]),
    .B1(_148_),
    .Y(_149_));
 sky130_fd_sc_hd__o22a_2 _222_ (.A1(B[5]),
    .A2(A[5]),
    .B1(_146_),
    .B2(_149_),
    .X(_150_));
 sky130_fd_sc_hd__a311o_2 _223_ (.A1(B[5]),
    .A2(A[5]),
    .A3(_141_),
    .B1(_144_),
    .C1(_150_),
    .X(_151_));
 sky130_fd_sc_hd__or2_2 _224_ (.A(B[0]),
    .B(B[1]),
    .X(_152_));
 sky130_fd_sc_hd__nand3b_2 _225_ (.A_N(OPCODE[0]),
    .B(OPCODE[1]),
    .C(OPCODE[2]),
    .Y(_153_));
 sky130_fd_sc_hd__o31a_2 _226_ (.A1(B[2]),
    .A2(_096_),
    .A3(_152_),
    .B1(_153_),
    .X(_154_));
 sky130_fd_sc_hd__xnor2_2 _227_ (.A(B[4]),
    .B(_154_),
    .Y(_155_));
 sky130_fd_sc_hd__nand2_2 _228_ (.A(A[4]),
    .B(_155_),
    .Y(_156_));
 sky130_fd_sc_hd__a21oi_2 _229_ (.A1(_153_),
    .A2(_152_),
    .B1(B[2]),
    .Y(_157_));
 sky130_fd_sc_hd__and3_2 _230_ (.A(B[2]),
    .B(_153_),
    .C(_152_),
    .X(_158_));
 sky130_fd_sc_hd__o21ai_2 _231_ (.A1(_157_),
    .A2(_158_),
    .B1(_098_),
    .Y(_159_));
 sky130_fd_sc_hd__and3_2 _232_ (.A(B[0]),
    .B(B[1]),
    .C(_153_),
    .X(_160_));
 sky130_fd_sc_hd__a21oi_2 _233_ (.A1(B[0]),
    .A2(_153_),
    .B1(B[1]),
    .Y(_161_));
 sky130_fd_sc_hd__o21a_2 _234_ (.A1(_160_),
    .A2(_161_),
    .B1(A[1]),
    .X(_162_));
 sky130_fd_sc_hd__or3_2 _235_ (.A(A[1]),
    .B(_160_),
    .C(_161_),
    .X(_163_));
 sky130_fd_sc_hd__or2b_2 _236_ (.A(A[0]),
    .B_N(B[0]),
    .X(_164_));
 sky130_fd_sc_hd__and3b_2 _237_ (.A_N(_162_),
    .B(_163_),
    .C(_164_),
    .X(_000_));
 sky130_fd_sc_hd__or3_2 _238_ (.A(_098_),
    .B(_157_),
    .C(_158_),
    .X(_001_));
 ...
 sky130_fd_sc_hd__o21ai_2 _240_ (.A1(_162_),
    ...
    .B1(_002_),
    .Y(_003_));
 sky130_fd_sc_hd__o21a_2 _241_ (.A1(B[2]),
    .A2(_152_),
    .B1(_153_),
    .X(_004_));
 sky130_fd_sc_hd__xnor2_2 _242_ (.A(_096_),
    .B(_004_),
    .Y(_005_));
 sky130_fd_sc_hd__nand2_2 _243_ (.A(_100_),
    .B(_005_),
    .Y(_006_));
 sky130_fd_sc_hd__nor2_2 _244_ (.A(_100_),
    .B(_005_),
    .Y(_007_));
 sky130_fd_sc_hd__or2_2 _245_ (.A(A[4]),
    .B(_155_),
    .X(_008_));
 sky130_fd_sc_hd__nand2_2 _246_ (.A(_156_),
    .B(_008_),
    .Y(_009_));
 sky130_fd_sc_hd__a311o_2 _247_ (.A1(_159_),
    ...
    .C1(_009_),
    .X(_010_));
 sky130_fd_sc_hd__a21o_2 _248_ (.A1(B[4]),
    .A2(_153_),
    .B1(_154_),
    .X(_011_));
 sky130_fd_sc_hd__xnor2_2 _249_ (.A(B[5]),
    .B(_011_),
    .Y(_012_));
 sky130_fd_sc_hd__or2_2 _250_ (.A(A[5]),
    .B(_012_),
    .X(_013_));
 sky130_fd_sc_hd__nand2_2 _251_ (.A(A[5]),
    .B(_012_),
    .Y(_014_));
 sky130_fd_sc_hd__nand2_2 _252_ (.A(_013_),
    .B(_014_),
    .Y(_015_));
 sky130_fd_sc_hd__a21o_2 _253_ (.A1(_156_),
    .A2(_010_),
    .B1(_015_),
    .X(_016_));
 sky130_fd_sc_hd__nand3_2 _254_ (.A(_015_),
    .B(_156_),
    .C(_010_),
    .Y(_017_));
 sky130_fd_sc_hd__and3_2 _255_ (.A(OPCODE[2]),
    .B(_094_),
    .C(_140_),
    .X(_018_));
 sky130_fd_sc_hd__and3_2 _256_ (.A(_016_),
    .B(_017_),
    .C(_018_),
    .X(_019_));
 sky130_fd_sc_hd__a211o_2 _257_ (.A1(_095_),
    .A2(_139_),
    .B1(_151_),
    .C1(_019_),
    .X(OUT[5]));
 sky130_fd_sc_hd__o31a_2 _258_ (.A1(B[5]),
    .A2(B[4]),
    .A3(_154_),
    .B1(_153_),
    .X(_020_));
 sky130_fd_sc_hd__xnor2_2 _259_ (.A(B[6]),
    .B(_020_),
    .Y(_021_));
 sky130_fd_sc_hd__and2_2 _260_ (.A(A[6]),
    .B(_021_),
    .X(_022_));
 sky130_fd_sc_hd__nor2_2 _261_ (.A(A[6]),
    .B(_021_),
    .Y(_023_));
 sky130_fd_sc_hd__or2_2 _262_ (.A(_022_),
    .B(_023_),
    .X(_024_));
 sky130_fd_sc_hd__inv_2 _263_ (.A(_013_),
    .Y(_025_));
 sky130_fd_sc_hd__a31o_2 _264_ (.A1(_014_),
    .A2(_156_),
    .A3(_010_),
    .B1(_025_),
    .X(_026_));
 sky130_fd_sc_hd__nand2_2 _265_ (.A(_024_),
    .B(_026_),
    .Y(_027_));
 sky130_fd_sc_hd__a311oi_2 _266_ (.A1(_014_),
    ...
    .C1(_025_),
    .Y(_028_));
 sky130_fd_sc_hd__and2b_2 _267_ (.A_N(_028_),
    .B(_018_),
    .X(_029_));
 sky130_fd_sc_hd__a21oi_2 _268_ (.A1(_099_),
    .A2(_132_),
    .B1(_101_),
    .Y(_030_));
 sky130_fd_sc_hd__nand3_2 _269_ (.A(_096_),
    .B(_100_),
    .C(_030_),
    .Y(_031_));
 sky130_fd_sc_hd__a21o_2 _270_ (.A1(_096_),
    .A2(_100_),
    .B1(_030_),
    .X(_032_));
 sky130_fd_sc_hd__nand2_2 _271_ (.A(_031_),
    .B(_032_),
    .Y(_033_));
 sky130_fd_sc_hd__a21o_2 _272_ (.A1(_118_),
    .A2(_135_),
    .B1(_134_),
    .X(_034_));
 sky130_fd_sc_hd__or2_2 _273_ (.A(_033_),
    .B(_034_),
    .X(_035_));
 sky130_fd_sc_hd__nand2_2 _274_ (.A(_033_),
    .B(_034_),
    .Y(_036_));
 sky130_fd_sc_hd__nor2_2 _275_ (.A(B[6]),
    .B(A[6]),
    .Y(_037_));
 sky130_fd_sc_hd__nand2_2 _276_ (.A(B[6]),
    .B(A[6]),
    .Y(_038_));
 sky130_fd_sc_hd__or3b_2 _277_ (.A(_148_),
    .B(_037_),
    .C_N(_038_),
    .X(_039_));
 sky130_fd_sc_hd__a211o_2 _278_ (.A1(OPCODE[1]),
    .A2(_038_),
    .B1(_037_),
    .C1(_145_),
    .X(_040_));
 sky130_fd_sc_hd__o211ai_2 _279_ (.A1(A[6]),
    .A2(_143_),
    .B1(_039_),
    .C1(_040_),
    .Y(_041_));
 sky130_fd_sc_hd__a31o_2 _280_ (.A1(_095_),
    .A2(_035_),
    .A3(_036_),
    .B1(_041_),
    .X(_042_));
 sky130_fd_sc_hd__a21o_2 _281_ (.A1(_027_),
    .A2(_029_),
    .B1(_042_),
    .X(OUT[6]));
 sky130_fd_sc_hd__xnor2_2 _282_ (.A(B[7]),
    .B(A[7]),
    .Y(_043_));
 sky130_fd_sc_hd__o21a_2 _283_ (.A1(B[6]),
    .A2(_020_),
    .B1(_153_),
    .X(_044_));
 sky130_fd_sc_hd__xor2_2 _284_ (.A(_043_),
    .B(_044_),
    .X(_045_));
 sky130_fd_sc_hd__o21ai_2 _285_ (.A1(_022_),
    .A2(_028_),
    .B1(_045_),
    .Y(_046_));
 sky130_fd_sc_hd__or3_2 _286_ (.A(_022_),
    .B(_028_),
    .C(_045_),
    .X(_047_));
 sky130_fd_sc_hd__o21ai_2 _287_ (.A1(_033_),
    .A2(_034_),
    .B1(_031_),
    .Y(_048_));
 sky130_fd_sc_hd__o21a_2 _288_ (.A1(B[7]),
    .A2(A[7]),
    .B1(_146_),
    .X(_049_));
 sky130_fd_sc_hd__a31oi_2 _289_ (.A1(B[7]),
    .A2(A[7]),
    .A3(_141_),
    .B1(_049_),
    .Y(_050_));
 sky130_fd_sc_hd__o221a_2 _290_ (.A1(A[7]),
    .A2(_143_),
    .B1(_043_),
    .B2(_148_),
    .C1(_050_),
    .X(_051_));
 sky130_fd_sc_hd__a21bo_2 _291_ (.A1(_095_),
    .A2(_048_),
    .B1_N(_051_),
    .X(_052_));
 sky130_fd_sc_hd__a31o_2 _292_ (.A1(_018_),
    .A2(_046_),
    .A3(_047_),
    .B1(_052_),
    .X(OUT[7]));
 sky130_fd_sc_hd__or2_2 _293_ (.A(_095_),
    .B(_141_),
    .X(_053_));
 sky130_fd_sc_hd__o211ai_2 _294_ (.A1(B[0]),
    .A2(A[0]),
    .B1(_094_),
    .C1(_140_),
    .Y(_054_));
 sky130_fd_sc_hd__a31o_2 _295_ (.A1(B[0]),
    .A2(A[0]),
    .A3(_145_),
    .B1(_054_),
    .X(_055_));
 sky130_fd_sc_hd__o21ai_2 _296_ (.A1(A[0]),
    .A2(_143_),
    .B1(_055_),
    .Y(_056_));
 sky130_fd_sc_hd__a31o_2 _297_ (.A1(B[0]),
    .A2(A[0]),
    .A3(_053_),
    .B1(_056_),
    .X(OUT[0]));
 sky130_fd_sc_hd__a21oi_2 _298_ (.A1(A[1]),
    .A2(B[1]),
    .B1(_148_),
    .Y(_057_));
 sky130_fd_sc_hd__o22a_2 _299_ (.A1(A[1]),
    .A2(B[1]),
    .B1(_146_),
    .B2(_057_),
    .X(_058_));
 sky130_fd_sc_hd__a22o_2 _300_ (.A1(B[0]),
    .A2(A[1]),
    .B1(B[1]),
    .B2(A[0]),
    .X(_059_));
 sky130_fd_sc_hd__and3b_2 _301_ (.A_N(_123_),
    .B(_095_),
    .C(_059_),
    .X(_060_));
 sky130_fd_sc_hd__a31o_2 _302_ (.A1(A[1]),
    .A2(B[1]),
    .A3(_141_),
    .B1(_060_),
    .X(_061_));
 sky130_fd_sc_hd__nor2_2 _303_ (.A(A[1]),
    .B(_143_),
    .Y(_062_));
 sky130_fd_sc_hd__and2b_2 _304_ (.A_N(_162_),
    .B(_163_),
    .X(_063_));
 sky130_fd_sc_hd__nor2_2 _305_ (.A(_063_),
    .B(_164_),
    .Y(_064_));
 sky130_fd_sc_hd__or3b_2 _306_ (.A(_000_),
    .B(_064_),
    .C_N(_018_),
    .X(_065_));
 sky130_fd_sc_hd__or4b_2 _307_ (.A(_058_),
    .B(_061_),
    .C(_062_),
    .D_N(_065_),
    .X(_066_));
 sky130_fd_sc_hd__buf_1 _308_ (.A(_066_),
    .X(OUT[1]));
 sky130_fd_sc_hd__or3_2 _309_ (.A(_002_),
    .B(_162_),
    .C(_000_),
    .X(_067_));
 sky130_fd_sc_hd__o21ai_2 _310_ (.A1(_122_),
    .A2(_123_),
    .B1(_095_),
    .Y(_068_));
 sky130_fd_sc_hd__a21oi_2 _311_ (.A1(_098_),
    .A2(B[2]),
    .B1(_148_),
    .Y(_069_));
 sky130_fd_sc_hd__o22a_2 _312_ (.A1(_098_),
    .A2(B[2]),
    .B1(_146_),
    .B2(_069_),
    .X(_070_));
 sky130_fd_sc_hd__nor2_2 _313_ (.A(_098_),
    .B(_143_),
    .Y(_071_));
 sky130_fd_sc_hd__a311o_2 _314_ (.A1(_098_),
    .A2(B[2]),
    .A3(_141_),
    .B1(_070_),
    .C1(_071_),
    .X(_072_));
 sky130_fd_sc_hd__o21bai_2 _315_ (.A1(_124_),
    .A2(_068_),
    .B1_N(_072_),
    .Y(_073_));
 sky130_fd_sc_hd__a31o_2 _316_ (.A1(_003_),
    .A2(_018_),
    .A3(_067_),
    .B1(_073_),
    .X(OUT[2]));
 sky130_fd_sc_hd__or2b_2 _317_ (.A(_007_),
    .B_N(_006_),
    .X(_074_));
 sky130_fd_sc_hd__nand2_2 _318_ (.A(_159_),
    .B(_003_),
    .Y(_075_));
 sky130_fd_sc_hd__xnor2_2 _319_ (.A(_074_),
    .B(_075_),
    .Y(_076_));
 sky130_fd_sc_hd__xor2_2 _320_ (.A(_124_),
    .B(_127_),
    .X(_077_));
 sky130_fd_sc_hd__a21oi_2 _321_ (.A1(_096_),
    .A2(_100_),
    .B1(_148_),
    .Y(_078_));
 sky130_fd_sc_hd__o22a_2 _322_ (.A1(_096_),
    .A2(_100_),
    .B1(_146_),
    .B2(_078_),
    .X(_079_));
 sky130_fd_sc_hd__nor2_2 _323_ (.A(_100_),
    .B(_143_),
    .Y(_080_));
 sky130_fd_sc_hd__a311o_2 _324_ (.A1(_096_),
    .A2(_100_),
    .A3(_141_),
    .B1(_079_),
    .C1(_080_),
    .X(_081_));
 sky130_fd_sc_hd__a221o_2 _325_ (.A1(_018_),
    .A2(_076_),
    .B1(_077_),
    .B2(_095_),
    .C1(_081_),
    .X(OUT[3]));
 sky130_fd_sc_hd__a31o_2 _326_ (.A1(_159_),
    .A2(_003_),
    .A3(_006_),
    .B1(_007_),
    .X(_082_));
 sky130_fd_sc_hd__nand2_2 _327_ (.A(_009_),
    .B(_082_),
    .Y(_083_));
 sky130_fd_sc_hd__and3_2 _328_ (.A(_010_),
    .B(_018_),
    .C(_083_),
    .X(_084_));
 sky130_fd_sc_hd__nor2_2 _329_ (.A(B[4]),
    .B(A[4]),
    .Y(_085_));
 sky130_fd_sc_hd__and2b_2 _330_ (.A_N(_085_),
    .B(_146_),
    .X(_086_));
 sky130_fd_sc_hd__a31o_2 _331_ (.A1(B[4]),
    .A2(A[4]),
    .A3(_141_),
    .B1(_086_),
    .X(_087_));
 sky130_fd_sc_hd__a21o_2 _332_ (.A1(_124_),
    .A2(_127_),
    .B1(_119_),
    .X(_088_));
 sky130_fd_sc_hd__o22a_2 _333_ (.A1(A[4]),
    .A2(_143_),
    .B1(_085_),
    .B2(_148_),
    .X(_089_));
 sky130_fd_sc_hd__a21oi_2 _334_ (.A1(B[4]),
    .A2(A[4]),
    .B1(_089_),
    .Y(_090_));
 sky130_fd_sc_hd__a31o_2 _335_ (.A1(_128_),
    .A2(_095_),
    .A3(_088_),
    .B1(_090_),
    .X(_091_));
 sky130_fd_sc_hd__or3_2 _336_ (.A(_084_),
    .B(_087_),
    .C(_091_),
    .X(_092_));
